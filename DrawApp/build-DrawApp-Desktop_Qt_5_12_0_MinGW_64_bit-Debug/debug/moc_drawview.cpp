...
QT_MOC_LITERAL(1, 9, 24), // "sendMouseCoordinateValue"
QT_MOC_LITERAL(2, 34, 0) // ""

    },
    "DrawView\0sendMouseCoordinateValue\0"
};
...
void DrawView::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->sendMouseCoordinateValue(); break;
        default: ;
        }
        ...
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            ...
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&DrawView::sendMouseCoordinateValue)) {
                *result = 0;
                return;
            }
        }
...
// SIGNAL 0
void DrawView::sendMouseCoordinateValue()
{
